    ...
    class UserApiController {
        ...
        public function getToken() {
            ...
            if(count($auth_header) != 2) {
                return $this->view->response("Error en los datos ingresados - metodo de autenticacion requerido", 400);
            }
            if($auth_header[0] != 'Basic') {
                return $this->view->response("Error en los datos ingresados - metodo no permitido", 400);
            }
            ...
            if($user == null || !password_verify($user_pass[1], $user->password)) {
                return $this->view->response("Error en los datos ingresados-contraseña incorrecta", 400);
            }
            // Generamos el token
